...
class Wait(State):
    def __init__(self, *args):
        ...
        self.voice_padding_constant = conf.voice_padding_constant_wait
        self.voice_padding = conf.voice_padding_init_wait
...
class Greeting(State):
    def __init__(self, *args):
        ...
        self.voice_padding_constant = conf.voice_padding_constant_greeting
        self.voice_padding = conf.voice_padding_init_greeting
...
class Book(Game):
    ...
    def voice(self):
        if self.stage() == 0:
            text = [self.rur_process(self.rur_text) + self.text['end'][0]]
            self.stage_add()
        elif self.stage() == 1:
            self.stage_add()
            text = ['']
